...
public class combobox_data_pelanggan_apiutils {
    public static combobox_data_pelanggan_apiservice getAPIService() {
        return config_apiclient.getClient(BASE_URL).create(combobox_data_pelanggan_apiservice.class);
    }
}
