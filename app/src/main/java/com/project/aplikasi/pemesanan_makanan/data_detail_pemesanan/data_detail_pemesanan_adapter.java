...
public class data_detail_pemesanan_adapter extends BaseAdapter {

    Activity activity;
    ArrayList<data_detail_pemesanan_apidata> data;
    ...
    public data_detail_pemesanan_adapter(Activity activity, ArrayList<data_detail_pemesanan_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_detail_pemesanan_tampil, null);
        }
        ...
        if (p != null) {
            ...
            id_detail_pemesanan = (TextView) v.findViewById(R.id.id_detail_pemesanan);
            ...
            tombol_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("", data.get(position).get_id_detail_pemesanan());
                    bundle.putString("id_pemesanan", data.get(position).get_id_pemesanan());
                    bundle.putString("id_menu_makanan", data.get(position).get_id_menu_makanan());
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
									...
									mAPIService.proses_hapus_data_detail_pemesanan(
											data.get(position).get_id_detail_pemesanan(),
											token
									).enqueue(new Callback<Object>() {			  
										@Override
										public void onResponse(Call<Object> call, Response<Object> response) {
											((data_detail_pemesanan_activity)activity).fetch_data_detail_pemesanan();
										}
            ...
            id_detail_pemesanan.setText("id_detail_pemesanan "+data.get(position).get_id_detail_pemesanan());
