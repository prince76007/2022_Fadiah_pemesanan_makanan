...
public class data_pemesanan_activity_v2 extends AppCompatActivity {

    ArrayList<data_pemesanan_apidata> result = new ArrayList<>();
    data_pemesanan_adapter_v2 adapter;
    RecyclerView data_pemesanan_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_pemesanan_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_pemesanan_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_pemesanan_activity_v2.this,
    ...
    public void fetch_data_pemesanan(){
        ...
        tokennya = token;
        mAPIService.tampil_data_pemesanan(
                "status",status, token, "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_pemesanan_api> call, Response<data_pemesanan_api> response) {
				...
				int jumlah_data = data_pemesanan_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_pemesanan_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_pemesanan_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_pemesanan_activity_v2.this,
