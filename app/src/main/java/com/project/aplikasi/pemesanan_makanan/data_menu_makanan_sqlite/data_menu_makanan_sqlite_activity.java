...
public class data_menu_makanan_sqlite_activity extends AppCompatActivity {

    private RecyclerView data_menu_makanan_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_menu_makanan_activity_v2);
        ...
        data_menu_makanan_tampil = (RecyclerView) findViewById(R.id.data_menu_makanan_tampil);
        data_menu_makanan_tampil.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(data_menu_makanan_sqlite_activity.this);
        data_menu_makanan_tampil.setLayoutManager(layoutManager);
        fetch_data_menu_makanan_sqlite();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Tambah
                Intent intent = new Intent( data_menu_makanan_sqlite_activity.this, data_menu_makanan_sqlite_tambah.class);
        ...
        tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Refresh
                fetch_data_menu_makanan_sqlite();
                Toast.makeText(data_menu_makanan_sqlite_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_menu_makanan_sqlite(){
        dbHandler = new data_menu_makanan_sqlite_dbhandler( data_menu_makanan_sqlite_activity.this);
        datalist = dbHandler.get_semua_data_menu_makanan_sqlite();
        adapter = new data_menu_makanan_sqlite_adapter(data_menu_makanan_sqlite_activity.this, datalist );
        data_menu_makanan_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        if (adapter.getItemCount() == 0){

            data_menu_makanan_tampil.setVisibility(View.GONE);
        } else {

            data_menu_makanan_tampil.setVisibility(View.VISIBLE);
            data_menu_makanan_tampil.addOnItemTouchListener(
                    new data_menu_makanan_sqlite_recyclerclick(getApplicationContext(), new data_menu_makanan_sqlite_recyclerclick.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            data_menu_makanan_sqlite_data mhs = datalist.get(position);
    ...
    private String[] spinnerArray = {
     ...
     private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_menu_makanan_sqlite_activity.this);
        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.data_menu_makanan_pencarian, null);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_menu_makanan_sqlite_activity.this,
    ...
    private void fetch_cari()
    {
        ...
        dbHandler = new data_menu_makanan_sqlite_dbhandler( data_menu_makanan_sqlite_activity.this);
        datalist = dbHandler.get_data_menu_makanan_sqlite(berdasarkan,isi,tanggal1,tanggal2,limit,halaman);
        adapter = new data_menu_makanan_sqlite_adapter(data_menu_makanan_sqlite_activity.this, datalist );
        data_menu_makanan_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
