...
public class data_menu_makanan_activity_v2 extends AppCompatActivity {

    ArrayList<data_menu_makanan_apidata> result = new ArrayList<>();
    data_menu_makanan_adapter_v2 adapter;
    RecyclerView data_menu_makanan_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_menu_makanan_adapter_v2(result, this);
        layoutManager = new GridLayoutManager(data_menu_makanan_activity_v2.this,2);
...
//		loading = new loading(this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_menu_makanan_activity_v2.this,
                        data_menu_makanan_tambah.class);
...
//          }
        ...
        mAPIService.tampil_data_menu_makanan(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_menu_makanan_api> call, Response<data_menu_makanan_api> response) {
				...
				int jumlah_data = data_menu_makanan_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_menu_makanan_activity_v2.this, "Data Berhasil Diperbarui",
...
//					loading.hideDialog();
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_menu_makanan_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_menu_makanan_activity_v2.this,
    ...
    public void carts(View view) {
        ...
        String token = new config_global().ambil(this);
        intent.putExtra("id_pemesanan",token);
        startActivityForResult(intent, REQUEST_CODE_TAMBAH);
