...
public class data_detail_pemesanan_sqlite_data {
    ...
    public data_detail_pemesanan_sqlite_data() {
    }

    public data_detail_pemesanan_sqlite_data(String id_detail_pemesanan
    ,String id_pemesanan
