...
public class data_pelanggan_sqlite_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_editdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validasi =="gagal") {
                    Toast.makeText( data_pelanggan_sqlite_edit.this,  "Gagal Proses, Ada data Yang Masih Kosong dan Perlu diinputkan.",
                            Toast.LENGTH_LONG ).show();
                    hideLoading();
                }  else {
                    //proses simpan
                    dbHandler.update_data_pelanggan_sqlite( new data_pelanggan_sqlite_data(
                    ...
                    adapter = new data_pelanggan_sqlite_adapter( data_pelanggan_sqlite_edit.this, data_pelanggan_sqliteList );
                    adapter.notifyDataSetChanged();
                    Toast.makeText( data_pelanggan_sqlite_edit.this, "Berhasil Mengupdate Data", Toast.LENGTH_SHORT ).show();
                    setResult( RESULT_OK );
