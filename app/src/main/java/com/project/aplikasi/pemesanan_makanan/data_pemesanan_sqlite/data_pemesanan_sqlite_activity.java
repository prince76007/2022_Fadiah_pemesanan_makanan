...
public class data_pemesanan_sqlite_activity extends AppCompatActivity {

    private RecyclerView data_pemesanan_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_pemesanan_activity_v2);
        ...
        data_pemesanan_tampil = (RecyclerView) findViewById(R.id.data_pemesanan_tampil);
        data_pemesanan_tampil.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(data_pemesanan_sqlite_activity.this);
        data_pemesanan_tampil.setLayoutManager(layoutManager);
        fetch_data_pemesanan_sqlite();

        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Tambah
                Intent intent = new Intent( data_pemesanan_sqlite_activity.this, data_pemesanan_sqlite_tambah.class);
        ...
        tombol_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Refresh
                fetch_data_pemesanan_sqlite();
                Toast.makeText(data_pemesanan_sqlite_activity.this, "Data Berhasil Diperbarui",
    ...
    public void fetch_data_pemesanan_sqlite(){
        dbHandler = new data_pemesanan_sqlite_dbhandler( data_pemesanan_sqlite_activity.this);
        datalist = dbHandler.get_semua_data_pemesanan_sqlite();
        adapter = new data_pemesanan_sqlite_adapter(data_pemesanan_sqlite_activity.this, datalist );
        data_pemesanan_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        if (adapter.getItemCount() == 0){

            data_pemesanan_tampil.setVisibility(View.GONE);
        } else {

            data_pemesanan_tampil.setVisibility(View.VISIBLE);
            data_pemesanan_tampil.addOnItemTouchListener(
                    new data_pemesanan_sqlite_recyclerclick(getApplicationContext(), new data_pemesanan_sqlite_recyclerclick.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            data_pemesanan_sqlite_data mhs = datalist.get(position);
    ...
    private String[] spinnerArray = {
     ...
     private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_pemesanan_sqlite_activity.this);
        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.data_pemesanan_pencarian, null);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_pemesanan_sqlite_activity.this,
    ...
    private void fetch_cari()
    {
        ...
        dbHandler = new data_pemesanan_sqlite_dbhandler( data_pemesanan_sqlite_activity.this);
        datalist = dbHandler.get_data_pemesanan_sqlite(berdasarkan,isi,tanggal1,tanggal2,limit,halaman);
        adapter = new data_pemesanan_sqlite_adapter(data_pemesanan_sqlite_activity.this, datalist );
        data_pemesanan_tampil.setAdapter(adapter);
        adapter.notifyDataSetChanged();
