...
public class data_kategori_tambah_v2_adapter extends BaseAdapter {
...
;
    ...
    public data_kategori_tambah_v2_adapter(Activity activity, ArrayList<data_kategori_apidata> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate( R.layout.data_kategori_tambah_v2_tampil, null);
        }
        ...
        if (p != null) {
			...
			loading = new loading((data_kategori_tambah_v2)activity);
