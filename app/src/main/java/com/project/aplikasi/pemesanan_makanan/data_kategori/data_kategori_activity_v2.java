...
public class data_kategori_activity_v2 extends AppCompatActivity {

    ArrayList<data_kategori_apidata> result = new ArrayList<>();
    data_kategori_adapter_v2 adapter;
    RecyclerView data_kategori_tampil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new data_kategori_adapter_v2(result, this);
        layoutManager = new LinearLayoutManager(data_kategori_activity_v2.this);
        ...
        tombol_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( data_kategori_activity_v2.this,
                        data_kategori_tambah.class);
    ...
    public void fetch_data_kategori(){
        ...
        mAPIService.tampil_data_kategori(
                "","", "", "","","", "Bearer "+token
            ...
            public void onResponse(Call<data_kategori_api> call, Response<data_kategori_api> response) {
				...
				int jumlah_data = data_kategori_tampil.getAdapter().getItemCount();
                if (jumlah_data<1)
                {
                    gif_no_data();
                }
                ...
                if (isRefresh){
                    Toast.makeText(data_kategori_activity_v2.this, "Data Berhasil Diperbarui",
    ...
    private void DialogPencarian() {
        dialog = new AlertDialog.Builder(data_kategori_activity_v2.this);
        ...
        btDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(data_kategori_activity_v2.this,
